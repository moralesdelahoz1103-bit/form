...
function AccesoDenegado() {
  ...
  const messages = {
    no_autorizado: {
      ...
      mensaje: 'El acceso al sistema de creación de formularios de actividad está restringido a usuarios autorizados por Talento Humano.'
    },
    inactivo: {
          ...
          <div className="acceso-info-card">
            ...
            <ul>
              <li>
                ...
                El acceso al sistema de creación de formularios de actividad está restringido a usuarios autorizados por Talento Humano.
              </li>
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="20 6 9 17 4 12"></polyline>
